    ...
    public class Admin // This class handles the add and removal of items as well as displaying the items.
    {
        ...
        public Admin()
        {
            items = new List<Items> // starting item list 
            {
                ...
                new Items(4, "Ice Cream Sandwich", "A frozen vanilla ice cream treat"),
                new Items(5, "Beef Jerky", "High-protein dried meat snack"),
                new Items(6, "Fresh Cookie", "Soft-baked chocolate chip cookie"),
                new Items(7, "Green Tea", "Refreshing unsweetened tea")
            };
